    ...
    public partial class initdatabase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Bangladesh", new DateTimeOffset(new DateTime(2023, 8, 9, 13, 58, 39, 462, DateTimeKind.Unspecified).AddTicks(8141), new TimeSpan(0, 6, 0, 0, 0)), "1", null, null, 1 });

            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "Id", "Created", "CreatedBy", "DepartmentName", "LastModified", "LastModifiedBy", "Status" },
                values: new object[] { 1, new DateTimeOffset(new DateTime(2023, 8, 9, 13, 58, 39, 460, DateTimeKind.Unspecified).AddTicks(1530), new TimeSpan(0, 6, 0, 0, 0)), "1", "IT", null, null, 1 });
